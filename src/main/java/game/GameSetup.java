...
public class GameSetup {
	...
	private static List<Player> player_types = List.of(new HumanPlayer(), new RandomPlayer(), new NaivePlayer(), new EvilPlayer(), new LBFSPlayer(),new ProtoMST(),new GreedyMST(),new IDDFS(),new AlphaBeta());
